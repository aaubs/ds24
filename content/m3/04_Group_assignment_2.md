...
## Introduction
Welcome to the final assignment for the Agentic System developed by CrewAI. This project is designed to deepen your understanding of modern AI techniques, particularly the integration of AI agents with GPT models, and their applications. You will leverage GPT models and AI agents to analyze data or solve a real world problem. The project involves using **CrewAI** to build and deploy AI workflows, utilize **prompt engineering techniquess** to enhance the performnace of the model, and develop an interactive **Streamlit** to showcase the results.

---

## Task Description
Create an innovative project that employs GPT models and AI agents to address a social scince question or analyze a data. The guidelines are intentionally broad to foster creativity. Below are some ideas to inspire your project:
